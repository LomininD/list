...
Смысл величины $k$ состоит в том, что она обратна скорости, т.е. кольцевой список на массивах, как и ожидалось, работает быстрее классического списка примерно в 3,1 раза.
